...
import { Ordering, SkipPaging, createSkipPaging } from "@superfluid-finance/sdk-core";
...
export const PoolDistributorsDataGridManager: FC<Props> = ({ network, accountAddress, poolAddress }) => {
    const [poolDistributorPaging, setPoolDistributorPaging] = useState<SkipPaging>(
        createSkipPaging({
            take: 10
        })
    )
