...
export const AccountPoolMemberRow: FC<AccountPoolMemberRow> = ({ network, member }) => {
    return (
                ...
                ({ currentData: pool }) => (
                    <TableRow hover>
                        ...
                        <TableCell data-cy={'amount-received'}>
                            {
                                pool ? (<PoolMemberTotalAmountReceived
                                    member={member}
                                    pool={{
                                ...
                                </PoolMemberTotalAmountReceived>) : <Skeleton sx={{ width: '100px' }} />
                            }
                        </TableCell>
