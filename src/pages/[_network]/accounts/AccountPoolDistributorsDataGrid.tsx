...
export const AccountPoolDistributorsDataGrid: FC<Props> = ({ network, accountAddress }) => {
    return (
        <Stack>
            ...
            <PoolDistributorsDataGridManager network={network} accountAddress={accountAddress} />
        </Stack>
    );
}