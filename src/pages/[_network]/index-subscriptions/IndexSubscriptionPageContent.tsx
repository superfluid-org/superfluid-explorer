...
export const IndexSubscriptionPageContent: FC<{
    ...
    const [
        subscriptionUnitsUpdatedEventPaging, setSubscriptionUnitsUpdatedEventPaging,
    ] = useState<SkipPaging>(
        createSkipPaging({
            take: 10,
        })
    ...
    const [
        subscriptionUnitsUpdatedEventPagingOrdering, setSubscriptionUnitsUpdatedEventOrdering,
                    ...
                    <Card elevation={2}>
                        <List>
                            <ListItem data-cy={"index-subscription-short-hash"} divider>
                                <ListItemText
                                    secondary="Index"
                                    primary={indexSubscription && index ? (
                                        <AppLink
                                            href={`/${network.slugName}/indexes/${index.id}`}
                                        >{`${index.id.substring(0, 6)}... (${index.indexId})`}</AppLink>
                                    ) : (
                        ...
                        <List>
                            ...
                            <ListItem data-cy={"subscription-total-amount-received"}>
                                <ListItemText
                                    ...
                                    primary={indexSubscription && index && totalWeiAmountReceived ? (
                                        <>
                                            <BalanceWithToken
