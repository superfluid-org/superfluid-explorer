...
import { cacheTagTypes, getSerializeQueryArgs, subgraphBaseQuery } from '@superfluid-finance/sdk-redux';
...
export const createSubgraphGdaApiSlice = <T extends ModuleName>(createRtkQueryApi: CreateApi<T>) =>
    createRtkQueryApi({
...
export type SubgraphGdaApiSliceEmpty = ReturnType<typeof createSubgraphGdaApiSlice>;
