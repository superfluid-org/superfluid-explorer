...
const Map: FC<{
  ...
  const OutgoingStreams: Stream[] = useMemo(() => (outgoingStreams.data?.data || []), [outgoingStreams.data]);
  const IncomingStreams: Stream[] = useMemo(() => (incomingStreams.data?.data || []), [incomingStreams.data]);
